export const settingsZhCN = {
  settings: {
    ...
    agentModeAuto: '自动生成',
    agentModeAutoDesc: 'AI 将根据对练主题自动生成适合的对练角色',
    autoAgentCount: '生成数量',
    autoAgentCountDesc: '自动生成的角色数量（含大师兄）',
    ...
    agentDescriptions: {
      'default-1': '主对练导师，带节奏、给反馈、关键时刻点名',
      'default-2': '帮你拆题补漏，卡住时递梯子',
      'default-3': '活跃气氛，用幽默让对练更有趣',
      'default-4': '专挑模糊点追问，逼你讲清楚',
      'default-5': '认真记录，整理对练重点与复盘',
      'default-6': '专门抬杠施压，练你的攻防表达',
    },
    close: '关闭',
    save: '保存',
    // Provider settings
    ...
    ttsVoiceConfigHint: '每个 Agent 的音色可在首页「对练角色配置」中设置',
    enableASR: '启用语音识别',
    ...
    dangerZone: '危险区域',
    security: '安全设置',
    securityDescription: '更新您的账户安全信息',
    changePassword: '修改密码',
    changePasswordDescription: '修改您的登录密码',
    ...
    clearCacheDescription:
      '删除所有本地存储的数据，包括对练记录、对话历史、音频缓存和应用配置。此操作不可撤销。',
    clearCacheConfirmTitle: '确定要清空所有缓存吗？',
    clearCacheConfirmDescription: '此操作将永久删除以下所有数据，且无法恢复：',
    clearCacheConfirmItems: '对练和场景数据、对话历史记录、音频和图片缓存、应用设置和偏好',
  ...
  profile: {
    ...
    chooseAvatar: '选择头像',
    uploadAvatar: '上传',
    bioPlaceholder: '介绍一下自己，大师兄会按你的背景定制对练...',
    avatarHint: '你的头像将显示在对练讨论和对话中',
...
export const settingsEnUS = {
  settings: {
    ...
    autoAgentCountDesc: 'Number of agents to auto-generate (including mentor)',
    ...
    required: 'Required',
    agentNames: {
      'default-1': 'Growth Mentor',
      'default-2': 'Drill Partner',
      'default-3': 'Energy Lead',
      'default-4': 'Cold-caller',
      'default-5': 'Debriefer',
      'default-6': 'Challenger',
    },
    agentRoles: {
      teacher: 'Mentor',
      assistant: 'Coach',
    ...
    agentDescriptions: {
      'default-1': 'Lead mentor — sets pace, gives feedback, cold-calls key moments',
      'default-2': 'Helps you unstick and fill gaps under pressure',
      'default-3': 'Keeps energy high and the room loose',
      'default-4': 'Pokes at vague answers until you get precise',
      'default-5': 'Captures notes and drives the debrief',
      'default-6': 'Pushes back hard so you practice defense',
    },
    close: 'Close',
    save: 'Save',
    // Provider settings
    ...
    ttsEnabledDescription: 'When enabled, speech audio will be generated during practice generation',
    ttsVoiceConfigHint:
      'Per-agent voice can be configured in "Practice Role Config" on the homepage',
    ...
    imageGenerationDisabledHint:
      'When enabled, images will be auto-generated during practice generation',
    ...
    videoGenerationDisabledHint:
      'When enabled, videos will be auto-generated during practice generation',
    ...
    securityDescription: 'Update your account security information',
    ...
    clearCacheDescription:
      'Delete all locally stored data, including practice records, chat history, audio cache, and app settings. This action cannot be undone.',
    ...
    clearCacheConfirmItems:
      'Practice sessions & scenes, Chat history, Audio & image cache, App settings & preferences',
  ...
  profile: {
    title: 'Profile',
    defaultNickname: 'Practitioner',
    chooseAvatar: 'Choose Avatar',
    uploadAvatar: 'Upload',
    bioPlaceholder: 'Tell us about yourself — the mentor will personalize practice for you...',
    avatarHint: 'Your avatar will appear in practice discussions and chats',
