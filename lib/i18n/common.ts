export const commonZhCN = {
  ...
  home: {
    slogan: '成长大师兄 · 和多智能体一起对练',
    greeting: '嗨，',
  },
  toolbar: {
    languageHint: '对练将以此语言进行',
    pdfParser: '解析器',
    pdfUpload: '上传 PDF',
    removePdf: '移除文件',
    webSearchOn: '已开启',
    ...
    configureProviderHint: '请先配置至少一个模型服务商才能生成对练',
    enterClassroom: '生成对练',
    advancedSettings: '高级设置',
    ttsTitle: '语音合成',
    ttsHint: '选择大师兄与同伴的朗读音色',
    ttsPreview: '试听',
    ttsPreviewing: '播放中...',
  },
  export: {
...
export const commonEnUS = {
  ...
  home: {
    slogan: 'GrowthMentor · multi-agent practice arena',
    greeting: 'Hi, ',
  },
  toolbar: {
    languageHint: 'Practice will run in this language',
    pdfParser: 'Parser',
    ...
    configureProviderHint: 'Configure at least one model provider to generate practice',
    enterClassroom: 'Generate Practice',
    advancedSettings: 'Advanced Settings',
    ttsTitle: 'Text-to-Speech',
    ttsHint: 'Choose voices for the mentor and peers',
    ttsPreview: 'Preview',
