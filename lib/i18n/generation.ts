export const generationZhCN = {
  ...
  generation: {
    ...
    goBackAndRetry: '返回重试',
    classroomReady: '你的个性化 AI 学习环境已成功生成。',
    ...
    agentGenerationDesc: '正在根据课程主题生成角色...',
...
export const generationEnUS = {
  ...
  upload: {
    ...
    generateFailed: 'Failed to generate course, please try again',
    requirementPlaceholder:
      'What do you want to learn or practice? e.g.\n"Python from zero — first program in 30 minutes"\n"Product review: sell this feature to the PM"\n"Behavioral interview: tell a conflict story"',
    requirementRequired: 'Please enter a course requirement',
  ...
  generation: {
    ...
    generatingOutlines: 'Generating Course Outline',
    generatingOutlinesDesc: 'Building the learning path...',
    ...
    generatingActionsDesc: 'Orchestrating narration, focus, and interaction flow...',
    ...
    sessionNotFoundDesc: 'Please fill in a course requirement to start generation.',
    goBackAndRetry: 'Go Back and Retry',
    classroomReady: 'Your personalized AI learning environment is ready.',
    ...
    agentGenerationDesc: 'Casting roles from your course topic...',
